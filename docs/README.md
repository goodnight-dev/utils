...
- **[API reference](https://goodnight-dev.github.io/utils/)** — generated from
  the source TSDoc comments (TypeDoc → GitHub Pages).
- **[Recipes](./recipes/)** — step-by-step guides for common contributor tasks.
...
- **[Architecture Decision Records](./adr/)** — the "why" behind significant
  ...
  - [0003 — Substantiating performance claims](./adr/0003-substantiating-performance-claims.md)
