...
| ------------------------------------ | ---------: | -----: | --------------------------- |
| **chosen** (indexed, pre-sized)      |     96,153 | ±0.55% | —                           |
| indexed, push (no pre-sized array)   |     82,873 | ±0.56% | chosen 1.16× faster         |
| `for...of` (code-point, push)        |     52,532 | ±0.36% | chosen 1.83× faster         |
| ASCII bitwise (**not** Unicode-safe) |    289,613 | ±0.35% | 3.01× faster — disqualified |
...
- The two correct rivals confirm the rationale above: pre-sizing the output
  ...
  loop is ~1.8× the throughput of the more readable `for...of`.
